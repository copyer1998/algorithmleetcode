...
the majority number is the number that ocurs more than 1/3 of the size of the array.
...
public:
     ...
     * @return: The majority number ocurs more than 1/3.
     */
...
public class Solution {
    /**
     * @param nums: A list of integers
     * @return: The majority number that ocurs more than 1/3
     */
