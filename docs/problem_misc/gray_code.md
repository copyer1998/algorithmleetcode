...
The gray code is a binary numeral system where two sucessive values differ in only one bit.
...
`[0,2,3,1]` is also a valid gray code sequence acording to the above definition.
